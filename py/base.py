...
# @Date: 2020-06-19 01:55:18
# @Last Modified by: Vlad Doster <mvdoster@gmail.com>
# @Last Modified time: 2020-06-19 23:27:50
...
class BaseDialog:
    ...
    def check_exit_request(self, code, ignore_Cancel=False):
        ...
        if code in (self.CANCEL, self.ESC):
            ...
            msg = "You pressed {0} in the last dialog box. Do you want " "really want to exit?".format(
                button_name[code]
            )
    ...
    def clear_screen(self):
        ...
        try:
            ...
            self.msgbox(
                "Unable to execute program '%s': %s." % (program, e.strerror), title="Error",
            )
            return False
